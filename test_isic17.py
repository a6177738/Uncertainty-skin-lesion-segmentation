...
def evaluate(add,epoch):
    ...
    for batch_i, (img ,label,img_id) in enumerate(dataloader):
        ...
        for b in range(img.shape[0]):
           cv2.imwrite("E:\\pifujing\data\\ISIC-2017\\threshold3\\"+img_id[b][-10:],fea_map[b,:,:]*255)
    ...
    print(epoch," avgacc:",a_pos/s_pos, " dice:",Dice/num ,"Jac: ",Jac/num, " SPE:",Spe/num," recall:",Recall/num)
    # t = str(epoch)+" avgacc:"+str(a_pos/s_pos)+ "  dice:"+str(Dice/num) +"  Jac: ",str(Jac/num)+ " SPE:"+str(Spe/num)+" recall:"+str(Recall/num)+'\n'
    # txt = open("txt\\isic17_result0.txt",mode="a+")
    # txt.writelines(t)
if __name__ == "__main__":
   # for i in range(100,173):
        evaluate("E:\\pifujing\\data\\ISIC-2017\\",str(113))