...
from data_test_ph2 import Data
import cv2
...
def evaluate_ph2(add,epoch):
    ...
    for batch_i, (img ,label,img_id) in enumerate(dataloader):
        ...
        #for b in range(img.shape[0]):
           #cv2.imwrite("E:\\pifujing\data\\PH2Dataset\\iteration4\\"+img_id[b][-10:].replace(".bmp",".png"),fea_map[b,:,:]*255)
    ...
    print(epoch," avgacc:",a_pos/s_pos, " dice:",Dice/num ,"Jac: ",Jac/num, " SPE:",Spe/num," SEN:",Recall/num, " P:", Precision/num)
    t = str(epoch)+" avgacc:"+str(a_pos/s_pos)+ "  dice:"+str(Dice/num) +"  Jac: ",str(Jac/num)+ " SPE:"+str(Spe/num)+" SEN:"+str(Recall/num)+'\n'
    #txt = open("txt\\ph1new.txt",mode="a+")
    #txt.writelines(t)
if __name__ == "__main__":
  #for i in range(0,60):

        evaluate_ph2("E:\\pifujing\\data\\PH2Dataset\\","isic18_i1e56")